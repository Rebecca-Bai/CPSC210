...
public class PizzaTest {
	...
	@Test
	public void testPizzaWithJustpepper() {
		pizza = new Pizza();
		Peppers pepper = new Peppers();
		pizza.addIngredient(pepper);
		assertEquals("crust toppedBy peppers", pizza.ingredientsAsString());
	...
	private void testPizzaWithJustSauce(int costOfSauce) {
		...
		assertEquals(sauce.computeCost(),costOfSauce);
	}
