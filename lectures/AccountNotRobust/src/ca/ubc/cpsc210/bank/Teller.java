...
public class Teller {
     ...
     * Process user input
     */
    public static void main(String[] args) throws IlligalValueException {
     ...
     */
    private static void doDeposit() throws IlligalValueException {
     ...
     */
    private static void doTransfer() throws IlligalValueException {
        System.out.println("\nTransfer from?");
