...
public class TestTodoList {
	...
	private ScheduledTodoItem ST;
	private UnscheduledTodoItem UT;
	...
	public void testGetAllTodoItems() {
		...
		todoList.addTodoItem(new ScheduledTodoItem("Groceries", "Pick up groceries at the UBC farmer's market.",currentDateTime));
		todoList.addTodoItem(new ScheduledTodoItem("Books on Magic", "Ask Twilight for recommendations for books on magic.",currentDateTime));
		todoList.addTodoItem(new ScheduledTodoItem("Vancouver Aquarium", "Visit the new Penguin Walk feature at the aquarium!",currentDateTime));
	...
	public void testGetTodoItemByIndex() {
		Date currentDateTime = new Date(); // Default date constructor creates a date object of current date/time
		todoList.addTodoItem(new ScheduledTodoItem("Fish Food", "Fish flakes or pellets?",currentDateTime));
		todoList.addTodoItem(new ScheduledTodoItem("Apple Cider", "Drop by Applejack's farm for cider season.",currentDateTime));
	...
	public void testAddTodoItem() {
		...
		todoList.addTodoItem(new UnscheduledTodoItem("Plan Courses", "Plan next year's courses.", false));
	...
	public void testFilterTodoItemsByIncompletion() {
		...
		todoList.addTodoItem(new UnscheduledTodoItem("Tutor", "Give Scootaloo some flying lessons!", false));
		todoList.addTodoItem(new UnscheduledTodoItem("Attend Class", "You shouldn't need to be reminded of that.", false));
	...
	public void testSetDuedate(){
		...
		ST=new ScheduledTodoItem(title, description,Duedate);
		ST.setDueDate(randomday);
		assertEquals(randomday,ST.getDueDate());
	}
...
ST=new ScheduledTodoItem(title, description,Duedate);
	...
	public void testsetHighPriority(){
		...
		UT=new UnscheduledTodoItem(title, description,highPriority);
		UT.setHighPriority(true);
		assertTrue(UT.isHighPriority());
	}
