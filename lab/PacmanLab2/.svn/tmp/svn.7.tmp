...
public class Board {
	...
	// Effects: move pacman, trackermonsters and randomMonsters
	...
	// Requires: nothing
	// Modifies: nothing
	// Effects:  if there is no food in board or pacman is caught, return true. otherwise produce false
	...
	// Requires: nothing
	// Modifies: nothing
	// Effects:  return true if the given sprite can move to the proper location on the board
	...
	// Requires: nothing
	// Modifies: nothing
	// Effects:  returns pacman in this board
