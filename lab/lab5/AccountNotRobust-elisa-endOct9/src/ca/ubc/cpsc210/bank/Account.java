...
public class Account {
	 ...
	 * REQUIRES: nothing
	 * MODIFIES: this
	 * EFFECTS: if amount is over ....throws a toomuchexception
	 * if........
	 * amount is added to balance and updated
	 * 			balance is returned
	 */
	public double deposit(double amount) throws IllegalValueException, TooMuchException {
        if (amount > 50000){
            throw new TooMuchException();
        }
        if (amount < 0){
            throw new IllegalValueException("YOU ARE A SILLY BILLY");
        }
        System.out.println("We're going to keep going");
