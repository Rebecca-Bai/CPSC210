...
public class Teller {
     ...
     * Process user input
     */
    public static void main(String[] args) throws IllegalValueException, TooMuchException {
        ...
        while(keepGoing) {
            ...
            if(command.equals("d"))
                try {
                    doDeposit();
                } catch (ca.ubc.cpsc210.bank.stupid stupid) {
     ...
     */
    private static void doDeposit() throws stupid {
        ...
        try {
            ...
            System.out.println("No ... but buy me dinner");
        }
        System.out.println("Telling you your balance now");
     ...
     */
    private static void doTransfer() throws IllegalValueException, TooMuchException {
        System.out.println("\nTransfer from?");
